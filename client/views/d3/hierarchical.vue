    ...
    <div class='tile is-ancestor'>
      <div class='tile is-parent'>
        <article class='tile is-child box'>
          <h4 class='title'>Hierarchical Edge Bundling</h4>
          <div id='hierarchical-edge'></div>
        </article>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    draw () {
      ...
      let svg = d3.select('#hierarchical-edge').append('svg')
        .attr('width', diameter)
      ...
      function mouseovered (d) {
        ...
        link
          .classed('link--target', function (l) { if (l.target === d) l.source.source = true })
          .classed('link--source', function (l) { if (l.source === d) l.target.target = true })
